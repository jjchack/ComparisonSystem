					...
					<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					  <ul i d="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
						<li role="presentation" class="active">
						  <a href="${pageContext.request.contextPath}/dealProduct?op=0" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">
							<span class="text">协同过滤推荐结果</span>
						  </a>
						</li>
					  </ul>
...
<!-- --------------------- -->
								<a href="${pageContext.request.contextPath}/dealProduct?op=1">协同比价推荐结果  </a>
