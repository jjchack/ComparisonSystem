...
<div class="form-bak">
	<form method="post" action="${pageContext.request.contextPath}/servlet/userRegister" onsubmit="adaptValue();">
		<div class="left">
		...
		<div class="right">
			...
			<div>已经拥有账号，<a href="index.jsp">直接登录</a></div>
			<div><font color="red">${requestScope.msg }</font></div>
		</div>
	</form>
</div>
