					...
					<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					  <ul i d="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
						<li role="presentation" class="next">
						  <a href="${pageContext.request.contextPath}/dealProduct?op=1" role="tab" id="profile-tab" >
							<span class="text">协同比价推荐结果</span>
						  </a>
						</li>
					  </ul>
...
<!-- --------------------- -->
								   <a href="${pageContext.request.contextPath}/dealProduct?op=0">协同过滤推荐结果</a>
								   <a href="${pageContext.request.contextPath}/dealProduct?op=2">系统最优推荐结果 </a>
								<div class="sort">
								  
								<img src="images/arrow_up_double_256px_539542_easyicon.net.png" title="" alt="" width="15"/>
								   <a href="${pageContext.request.contextPath}/dealProduct?op=1">用户评价优先 </a>
								   <a href="${pageContext.request.contextPath}/dealProduct?op=3">价格优先</a>
								 </div>
<!-- --------------------- -->								
								<div class="clearfix"></div>
							<ul class="list">
<c:forEach items="${sessionScope.ls}" var="product" varStatus="status" >
								<a href="#">
									<li>
