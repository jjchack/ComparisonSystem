...
<html>
<head>
<title>${sessionScope.pname}</title>
					  ...
					  <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
						<li role="presentation" class="active">
						  <a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">
							<span class="text">${sessionScope.pname}</span>
						  </a>
						</li>
...
<c:forEach items="${sessionScope.pb.pageData}" var="product" varStatus="status" >
						...
						<ul class="pagination pagination-sm">
							<li><a href="${pageContext.request.contextPath}/servlet/productInfor?property=${sessionScope.property}&pageNumber=${sessionScope.pb.currentPage-1}">Prev</a></li>
							<li><a href="#">第${sessionScope.pb.currentPage}页</a></li>
							<li><a href="${pageContext.request.contextPath}/servlet/productInfor?property=${sessionScope.property}&pageNumber=${sessionScope.pb.currentPage+1}">next</a></li>	
